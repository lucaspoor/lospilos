...
const images = [
  { route: "/im/hero/hero3.jpeg" },
  { route: "/im/hero/hero2.jpeg" },
  { route: "/im/hero/hero1.jpg" },
  { route: "/im/hero/hero4.jpeg" },
];
...
export default function Hero() {
  ...
  return (
    <div
      id="link_inicio"
      className={`overflow-clip relative md:h-[800px] sm:h-[750px] h-[650px] `}
    >
      <div className="flex justify-center bg-black bg-opacity-40 hero-overlay overflow-x-auto  ">
        {responsiveBanner ? (
          ...
          <div className="bg-cyan-900 sm:min-h-[1000px] h-auto lg:min-w-[1920px] sm:min-w-[1400px] min-h-[800px] min-w-[400px]  align-middle bg-center fixed top-0 -z-10"></div>
        )}
      </div>
