      ...
      <div className="max-w-5xl mx-auto px-6 ">
        ...
        <section className="py-8  grid md:grid-cols-3   gap-2">
          {lugares.map((item, idx) =>
            idx < 6 ? (
              <div data-aos="fade-up" key={idx} className="flex flex-col mx-2 my-4    ">
                <img
                  src={item.img}
                  alt={item.name}
         ...
         <div className={vermas ? "w-full py-10 pb-20 flex justify-center" : "w-full pb-20 flex justify-center" }>
            <a
            ...
            >
              {vermas ? <p>Quiero ver menos</p> : <p>Descubre mas lugares que visitar</p>}
            </a>
          </div>
      </div>
    </div>
